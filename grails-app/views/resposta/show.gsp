...
<html>
    ...
    <body>
        ...
        <div id="show-resposta" class="content scaffold-show" role="main">
            ...
            <f:display bean="resposta" />
            <g:form resource="${this.resposta}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.resposta}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
